...
<html>
    <head>
        ...
        <link href="<?php echo $this->carpeta_proyecto() ?>php-login/css/bootstrap.min.css" rel="stylesheet" type="text/css"/>
         <script src="<?php echo $this->carpeta_proyecto() ?>php-login/js/jquery-2.1.4.js" type="text/javascript"></script>
        <script src=" <?php echo $this->carpeta_proyecto() ?>php-login/js/bootstrap.min.js" type="text/javascript"></script>
         <script src="<?php echo $this->carpeta_proyecto() ?>php-login/js/config.js" type="text/javascript"></script>
